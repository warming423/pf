...
class MemoryRecord:
    '''
    记录内存操作的详细信息, eg. time stamp, device type, op name
    '''
...
class MemorySnapshot:
    ...
    # 遍历所有内存记录，计算每个设备类型和设备ID组合的内存分配峰值
    ...
    # 返回数据，数据形式为 'aten::transpose': [0, 50, 1, 0, 100, 2, 1], 'aten::tranas_stride': [0, 50, 1, 0, 50, 1, 1],
