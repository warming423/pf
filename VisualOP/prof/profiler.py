...
class DeviceActivity(ProfilerActivity):
    pass
...
class profile(object):
    ...
    def __init__(
            self,
            *,
            activities: Optional[Iterable[DeviceActivity]] = None,
        ...
        if use_cuda is not None:
            ...
            if use_cuda:
                self.activities.add(DeviceActivity.CUDA)
            elif DeviceActivity.CUDA in self.activities:
                self.activities.remove(DeviceActivity.CUDA)
    ...
    def _start_warmup(self):
        self.profiler = prof.profile(
            use_cuda=(DeviceActivity.CUDA in self.activities),
            use_cpu=(DeviceActivity.CPU in self.activities),
